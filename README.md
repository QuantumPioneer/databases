...
## Data availability 
The QuantumPioneer datasets are available for download on [Zenodo](https://zenodo.org/uploads/20060606). Python notebooks are provided to demonstrate how to load the datasets.
...
[(preview)](https://zenodo.org/records/20060606/preview/quantumpioneer_kinetics_dataset.csv?preview=1&include_deleted=0)
[(download)](https://zenodo.org/records/20060606/files/quantumpioneer_kinetics_dataset.csv?download=1&preview=1)
...
[(preview)](https://zenodo.org/records/20060606/preview/quantumpioneer_solvation_dataset_closed_shell_species.zip?preview=1&include_deleted=0)
[(download)](https://zenodo.org/records/20060606/files/quantumpioneer_solvation_dataset_closed_shell_species.zip?download=1&preview=1)

`quantumpioneer_solvation_dataset_open_shell_species.zip` (994.9 MB)
[(preview)](https://zenodo.org/records/20060606/preview/quantumpioneer_solvation_dataset_open_shell_species.zip?preview=1&include_deleted=0)
[(download)](https://zenodo.org/records/20060606/files/quantumpioneer_solvation_dataset_open_shell_species.zip?download=1&preview=1)

`quantumpioneer_solvation_dataset_reactions.zip` (1.1 GB)
[(preview)](https://zenodo.org/records/20060606/preview/quantumpioneer_solvation_dataset_reactions.zip?preview=1&include_deleted=0)
[(download)](https://zenodo.org/records/20060606/files/quantumpioneer_solvation_dataset_reactions.zip?download=1&preview=1)
...
[(preview)](https://zenodo.org/records/20060606/preview/quantumpioneer_thermo_dataset_closed_shell_species.csv?preview=1&include_deleted=0)
[(download)](https://zenodo.org/records/20060606/files/quantumpioneer_thermo_dataset_closed_shell_species.csv?download=1&preview=1)

`quantumpioneer_thermo_dataset_open_shell_species.csv` (41.5 MB)
[(preview)](https://zenodo.org/records/20060606/preview/quantumpioneer_thermo_dataset_open_shell_species.csv?preview=1&include_deleted=0)
[(download)](https://zenodo.org/records/20060606/files/quantumpioneer_thermo_dataset_open_shell_species.csv?download=1&preview=1)
...
[(preview)](https://zenodo.org/records/20060606/preview/quantumpioneer_thermo_dataset_transition_states.csv?preview=1&include_deleted=0)
[(download)](https://zenodo.org/records/20060606/files/quantumpioneer_thermo_dataset_transition_states.csv?download=1&preview=1)
...
[(preview)](https://zenodo.org/records/20060606/preview/species_dft_results.parquet?preview=1&include_deleted=0)
[(download)](https://zenodo.org/records/20060606/files/species_dft_results.parquet?download=1&preview=1)

`transition_state_dft_results.parquet` (1.4 GB)
[(preview)](https://zenodo.org/records/20060606/preview/transition_state_dft_results.parquet?preview=1&include_deleted=0)
[(download)](https://zenodo.org/records/20060606/files/transition_state_dft_results.parquet?download=1&preview=1)
...
[(preview)](https://zenodo.org/records/20060606/preview/species_semiempirical_results.parquet?preview=1&include_deleted=0)
[(download)](https://zenodo.org/records/20060606/files/species_semiempirical_results.parquet?download=1&preview=1)

`transition_state_semiempirical_results.parquet` (1.4 GB)
[(preview)](https://zenodo.org/records/20060606/preview/transition_state_semiempirical_results.parquet?preview=1&include_deleted=0)
[(download)](https://zenodo.org/records/20060606/files/transition_state_semiempirical_results.parquet?download=1&preview=1)
...
[(preview)](https://zenodo.org/records/20060606/preview/species_dlpno_results.parquet?preview=1&include_deleted=0)
[(download)](https://zenodo.org/records/20060606/files/species_dlpno_results.parquet?download=1&preview=1)

`transition_state_dlpno_results.parquet` (116.6 MB)
[(preview)](https://zenodo.org/records/20060606/preview/transition_state_dlpno_results.parquet?preview=1&include_deleted=0)
[(download)](https://zenodo.org/records/20060606/files/transition_state_dlpno_results.parquet?download=1&preview=1)
